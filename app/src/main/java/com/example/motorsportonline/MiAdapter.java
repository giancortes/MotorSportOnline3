...
public class MiAdapter extends RecyclerView.Adapter<MiAdapter.MiViewHolder> {
    ...
    public MiAdapter(Context ct, String nombre[], String ubicacion[], String horario[], String tipodereparacion[], String contacto[],int imagen[]){
        this.cont = ct;
        this.N = nombre;
        this.U = ubicacion;
        this.H = horario;
        this.T = tipodereparacion;
        this.C = contacto;
        this.A = imagen;
    }
    ...
    public class MiViewHolder extends RecyclerView.ViewHolder{
        ...
        public MiViewHolder(@NonNull View itemView) {
            ...
            ti = itemView.findViewById(R.id.tiporeparacion);
